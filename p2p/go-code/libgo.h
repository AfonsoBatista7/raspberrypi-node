...
extern void StartP2P(char** bootstrapPeers, GoInt bootstrapCount, transfer_data transfer, transfer_data debugLog, notify connectNotify, GoUint8 debug, char* playerId);
extern void WriteData(char* sendData);
extern void ConnectToPeer(char* peerID);
extern void ClosePeer();
